...
public class SetupDataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(final ContextRefreshedEvent event) {
        ...
        // == create initial user
        createUserIfNotFound("admin@admin.com", "admin", "admin", "admin", new ArrayList<>(Arrays.asList(adminRole)));
        createUserIfNotFound("user@user.com", "user", "user", "user", new ArrayList<>(Arrays.asList(userRole)));
